		...
		<header className='fixed top-0 left-0 w-full bg-gray-900 bg-opacity-90 backdrop-blur-md shadow-lg z-40 transition-all duration-300 border-b border-orange-800'>
			<div className='container mx-auto px-4 py-3'>
				<div className='flex flex-wrap justify-between items-center'>
					<Link to='/' className='text-2xl font-bold text-orange-600 items-center space-x-2 flex'>
						Bué T-Shirts
					</Link>
					 ...
					 ease-in-out'
						...
						{user && (
							...
							>
								...
								{cart.length > 0 && (
									<span
										className='absolute -top-2 -left-2 bg-orange-600 text-white rounded-full px-2 py-0.5 
						...
						{isAdmin && (
							<Link
								className='bg-orange-600 hover:bg-orange-700 text-white px-3 py-1 rounded-md font-medium
